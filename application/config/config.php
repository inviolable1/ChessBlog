...
|
*/
$config['log_threshold'] = (ENVIRONMENT == 'development') ? 3 : 0;   //use 3 for development (local stack)
...
|
*/
$config['encryption_key'] = 'xAXNeZjnTh4wyL58vuM8z1GrjLdtlBMH';
...
$config['sess_table_name']		= 'chessdimension_sessions';
...
|
*/
$config['cookie_prefix']	= 'chessdimension_';	//Might not need cookies for a static
...
*/
$config['csrf_protection'] = TRUE;		//Might not need CSRF for a static
$config['csrf_token_name'] = 'csrf_token';
$config['csrf_cookie_name'] = 'csrf_cookie';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = TRUE;	//NEED regeneration especially if a lot of AJAX used
